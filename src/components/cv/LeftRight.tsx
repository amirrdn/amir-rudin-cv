      ...
      <div className="mt-2 mb-2">
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path
              className="a"
              d="M24,5.5a9.2371,9.2371,0,1,1-9.22,9.2543v-.0172A9.2371,9.2371,0,0,1,24,5.5Z"
            ></path>
            <path
              className="a"
      ...
      <div className="mb-4 mt-14">
        <div className="flex-shrink-0 w-full h-px bg-current" />
          ...
          <div className="mt-2 grid grid-cols-2 gap-6">
            ...
            <div>Tailwind</div>
            <div><span className="float-end">Bootstrap</span></div>
            <div>Vuejs</div>
            <div><span className="float-end">Reactjs</span></div>
            <div>Laravel</div>
